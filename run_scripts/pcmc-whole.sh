...
python3 main.py log=pcmc-whole/incremental/seed$1 model=stam2-whole dataset=imagenet40-long scenario=incremental seed=$1 \
        load_pretrain=False pretrain_log=pcmc-whole/test model.encoder_type=simclr model.sleep_on=True \
